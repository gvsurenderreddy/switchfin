 ...
 *
 *  1. Fax detection application for all channel types.
 *  2. Playback a file with audio detect
 * 
...
static char *app_detectfax= "NVFaxDetect";

static char *synopsis_detectfax = "Detects fax sounds on all channel types (IAX and SIP too)";

static char *descrip_detectfax = 
...
static char *app_background_detect = "NVBackgroundDetect";

static char *synopsis_background_detect = "Background a file with talk and fax detect (IAX and SIP too)";

static char *descrip_background_detect = 
...
AST_MODULE_INFO(ASTERISK_GPL_KEY, AST_MODFLAG_DEFAULT, "NV Fax Detection Applications",
		.load = load_module,
