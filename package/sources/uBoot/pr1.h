/*
 * U-boot - Configuration file for SwitchVoice/Astfin PR1-Appliance Board board
 * 
 * mark@astfin.org
 * 
...
#define CONFIG_ETHADDR          02:80:ad:20:21:d9 
...
#define CONFIG_EXTRA_ENV_SETTINGS												\
	...
	"ramboot=tftpboot $loadaddr uImage;"											\
        ...
        "uvfile=u-boot-pr1.ver\0"                                								\
        "lvfile=uImage-pr1.ver\0"                               								\
        "ufile=u-boot-pr1.ldr\0"                                         							\
        "lfile=uImage-pr1\0"                                        								\
        "uv=ubxxx\0"                                    									\
        "lv=uixxx\0"                                                                                 				\
...
#else
#define	CFG_PROMPT		"pr1> "	/* Monitor Command Prompt */
#endif
#else
#if (BFIN_CPU == ADSP_BF534)
