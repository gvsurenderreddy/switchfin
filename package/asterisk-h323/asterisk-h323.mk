...
ASTERISK-H323_CFLAGS=-g -mfdpic -mfast-fp -ffast-math -D__FIXED_PT__ -D__BLACKFIN__
ASTERISK-H323_CFLAGS+= -I$(ASTERISK_DIR)/include -I$(STAGING_INC) -fno-jump-tables
ASTERISK-H323_LDFLAGS=-mfdpic -L$(STAGING_LIB) -lpthread -ldl
ASTERISK-H323_CONFIGURE_OPTS= --host=bfin-linux-uclibc --disable-largefile --without-pwlib
ASTERISK-H323_CONFIGURE_OPTS+= --without-curl
ASTERISK-H323_DEP=""

ASTERISK-H323_CFLAGS+= -I$(STAGING_INC)/include
ASTERISK-H323_CONFIGURE_OPTS+= CFLAGS="$(ASTERISK-H323_CFLAGS)" LDFLAGS="$(ASTERISK-H323_LDFLAGS)"
...
$(ASTERISK-H323_DIR)/.configured: $(ASTERISK-H323_DIR)/.unpacked
	cd $(ASTERISK-H323_DIR); ./configure $(ASTERISK-H323_CONFIGURE_OPTS)
	touch $(ASTERISK-H323_DIR)/.configured

asterisk-h323: asterisk $(ASTERISK-H323_DEP) $(ASTERISK-H323_DIR)/.configured

	OPTIMIZE="-Os" ASTCFLAGS="$(ASTERISK-H323_CFLAGS)" ASTLDFLAGS="$(ASTERISK-H323_LDFLAGS)" \
