...
# CONFIG_LIB_LIBJPEG_BFIN is not set
...
CONFIG_USER_MTDUTILS_UBIUTILS=y
...
# CONFIG_USER_DEBUG_DEBUG is not se
...
# CONFIG_USER_LRZSZ_LRZ is not set 
# CONFIG_USER_LRZSZ_LSZ is not set 
...
# CONFIG_USER_BUSYBOX_GETOPT_LONG is not set
# CONFIG_USER_BUSYBOX_FEATURE_DEVPTS is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_FIND_PERM is not set
# CONFIG_USER_BUSYBOX_FEATURE_FIND_TYPE is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_FIND_SIZE is not set 
...
# CONFIG_USER_BUSYBOX_FDISK_SUPPORT_LARGE_DISKS is not set
# CONFIG_USER_BUSYBOX_FEATURE_FDISK_WRITABLE is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_FDISK_ADVANCED is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_MOUNT_FLAGS is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_IFCONFIG_HW is not set
CONFIG_USER_BUSYBOX_FEATURE_IFCONFIG_BROADCAST_PLUS=y
...
#Added by jason for GUI 4.0 upload support
...
CONFIG_USER_BUSYBOX_FEATURE_HTTPD_CONFIG_WITH_SCRIPT_INTERPR=y
CONFIG_USER_BUSYBOX_FEATURE_HTTPD_ENCODE_URL_STR=y
CONFIG_USER_BUSYBOX_FEATURE_HTTPD_ERROR_PAGES=y
CONFIG_USER_BUSYBOX_FEATURE_HTTPD_PROXY=y
